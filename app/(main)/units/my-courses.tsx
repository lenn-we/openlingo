  ...
  return (
    <section className="mb-8">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="text-lg font-bold text-lingo-text">Meine Kurse</h2>
        <button
...
function OwnedCourseCard({
  ...
  function handleMakePublic() {
    const confirmed = window.confirm(
      "Bist du sicher, dass du diesen Kurs veröffentlichen möchtest?\n\n" +
        "Einmal öffentlich, kann dieser Kurs nicht mehr bearbeitet werden. " +
        "Nur Admins können öffentliche Inhalte ändern. " +
        "Alle Nutzer haben Zugriff auf diesen Kurs."
    );
    if (!confirmed) return;
  ...
  function handleDelete() {
    const confirmed = window.confirm(
      "Bist du sicher, dass du diesen Kurs löschen möchtest?\n\n" +
        "Die Lektionen in diesem Kurs werden NICHT gelöscht — sie werden zu eigenständigen Lektionen. " +
        ...
        <div className="flex min-w-0 items-center gap-3 p-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-x-2 gap-y-0.5 mt-1 text-xs text-lingo-text-light">
              ...
              <span>·</span>
              <span>
                {course.unitCount} {course.unitCount === 1 ? "Lektion" : "Lektionen"}
              </span>
