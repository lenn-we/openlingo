...
export function StandaloneUnits({ units, isAdmin }: StandaloneUnitsProps) {
  ...
  return (
    <section className="mb-8">
      <h2 className="mb-3 text-lg font-bold text-lingo-text">Meine Lektionen</h2>
...
function StandaloneUnitCard({
  ...
  function handleMakePublic() {
    const confirmed = window.confirm(
      "Bist du sicher, dass du diese Lektion veröffentlichen möchtest?\n\n" +
        "Einmal öffentlich, kann diese Lektion nicht mehr bearbeitet werden. " +
        "Nur Admins können öffentliche Inhalte ändern. " +
        "Alle Nutzer haben Zugriff auf diese Lektion und dein Name wird als Autor angezeigt."
    );
    if (!confirmed) return;
